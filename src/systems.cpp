...
float pyth3D(float x, float y, float z){
    ...
    void CoordinateSystem3D::cylinderToSphere(){
        ...
        CoordinateSystem2D::CoordinateSystem2D(float x, float y, float originX, float originY){
            this->X = x;
            this->Y = y;
        ...
        CoordinateSystem2D::CoordinateSystem2D(float radius, float phi, float originX, float originY){
            this->radius  = radius;
            this->phi     = phi;
            this->originX = originX;
            this->originY = originY;
    ...
    CoordinateSystem3D::CoordinateSystem3D(float X, float Y, float Z) : CoordinateSystem2D(X,Y) {
        this->Z   = Z;
    ...
    CoordinateSystem3D::CoordinateSystem3D(float X, float Y, float Z, float originX, float originY) : CoordinateSystem2D(X,Y,originX, originY) {
        this->Z   = Z;
        this->abs = pyth3D(this->X, this->Y, this->Z);
    ...
    CoordinateSystem3D::CoordinateSystem3D(float radius, float phi, float theta) : CoordinateSystem2D(radius,phi){
        this->theta = theta;
        
    }
    CoordinateSystem3D::CoordinateSystem3D(float radius, float phi, float theta, float originX, float originY) : 
    ...
    CoordinateSystem3D::CoordinateSystem3D(float radius, float phi, float height): CoordinateSystem2D(radius,phi){
        this->height = height;
    }
    CoordinateSystem3D::CoordinateSystem3D(float radius, float phi, float height, float originX, float originY) :
    CoordinateSystem2D(      radius,       phi,                     originX,       originY) {
        this->height = height;
    } 
#endif
    float CoordinateSystem2D::getX(){
        return this->X;
    }
    float CoordinateSystem2D::getY(){
        return this->Y;
    }
 
    float CoordinateSystem2D::getPhi(){
        return this->phi;
    }
    float CoordinateSystem2D::getRadius(){
        return this->radius;
    }
    float CoordinateSystem3D::getTheta(){
        return this->theta;
    }
    float CoordinateSystem3D::getHeight(){
        return this->height;
    }
    float CoordinateSystem3D::getZ(){
        return this->Z;
    }
